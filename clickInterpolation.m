...
function retval = clickInterpolation (input1, input2)
...
if length (xnew) <1
break
% if return pressed, terminate
end
k=k+1;
% k counts clicks
xlist(k)=xnew; ylist(k)=ynew; % add new point to the list
c=NewtonDividedDifferencesInterpolation(xlist,ylist); % get interpolation coeffs
x=xl:.01:xr;
% define x coordinates of curve
